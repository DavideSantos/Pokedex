      ...
      <div className="max-w-2xl mx-auto mt-2">
        <div className="bg-white shadow-2xl border border-gray-200 rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="p-5">
            ...
            <p className="font-normal text-gray-700 mb-3 dark:text-gray-400 capitalize">
              Peso: {props.pokemon.weight} kg
            </p>
            <p className="font-normal text-gray-700 mb-3 dark:text-gray-400 capitalize">
              Tipo di Pokèmon: {props.pokemon.types[0].type.name}
            </p>
            <div className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center  dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
              Dettagli
              <svg
