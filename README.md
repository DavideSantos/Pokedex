...
> Pokédex completo costruito con React 19 + Vite e tailwind v4, che usa le api di [PokéAPI v2](https://pokeapi.co/api/v2/).

🌐 **Live:** [pokedex.davide-santos.com](https://pokedex.davide-santos.com/)
